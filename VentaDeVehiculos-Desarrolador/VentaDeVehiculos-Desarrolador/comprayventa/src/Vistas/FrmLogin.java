...
import Validadaciones.LoginNegocio;
...
public class FrmLogin extends javax.swing.JFrame {
    ...
    private void btnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarActionPerformed
        String psw = String.valueOf(txtPsw.getText());
        if (txtusername.getText().isEmpty() && psw.isEmpty()) {
            JOptionPane.showMessageDialog(rootPane, "Faltan campos por diligenciar");
        } else {
            LoginNegocio lnegocio = new LoginNegocio();
            JFrame pantalla = lnegocio.ValidarIngreso(txtusername.getText(), psw);
            this.dispose();
